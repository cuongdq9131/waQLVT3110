<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="nhapvattu.ascx.cs" Inherits="waQLVT.Modules.nhapvattu" %>
...
function CloseForm1() {
        eval("parent.window.opener.location='" + parent.window.opener.location + "'");
        parent.close();
    }
</script>

<asp:Literal ID="ltrSave" runat="server" Visible="false"></asp:Literal>
...
<td align = "right">Loại vật tư</td>
    <td align="left">
        <asp:DropDownList ID="maloaivt" runat="server" Width="160px" 
            AutoPostBack="true" onselectedindexchanged="maloaivt_SelectedIndexChanged" oninit="maloaivt_Init" >           
        </asp:DropDownList>
    </td>
...
<tr>
 <td align = "right">Mã vật tư</td>
            <td align = "left" class="style1">
                <asp:TextBox ID="txtmvt" runat="server" Width="285px"></asp:TextBox>
                </td>
<td align = "right">Part Number</td>
            <td align = "left" class="style3">
                <asp:TextBox ID="txtpartno" runat="server" Width="250px"></asp:TextBox></td>      
</tr>

<tr>
<td align = "right">Tên vật tư</td>
            <td align = "left" >
                <asp:TextBox ID="txttenvt" runat="server" Width="370px"></asp:TextBox>
                &nbsp;&nbsp;&nbsp;&nbsp;
               
                <asp:AutoCompleteExtender ID="txtTenVT_AutoCompleteExtender1" runat="server" 
                    DelimiterCharacters="" Enabled="True" ServiceMethod="GetCompletionList" 
                    ServicePath="~/Sevices/AutocompleteService.asmx" TargetControlID="txttenvt" UseContextKey="True" 
                    ContextKey="sgTenVatTu" MinimumPrefixLength="1" CompletionSetCount="12">
...
<tr>
 ...
 <td align = "right">Gói thầu</td>
            <td align = "left" class="style3">
                 <asp:DropDownList ID="drmahd" runat="server" Width="250px" AutoPostBack="true"></asp:DropDownList>
...
<td align = "right">Địa điểm nhận</td>
            <td align = "left" class="style3">
                 <asp:DropDownList ID="drmavtd" runat="server" Width="148px" AutoPostBack=true></asp:DropDownList>
...
<tr>
    <td colspan="4" align = "center">
            <asp:Label ID="alert" runat="server" Font-Bold="True" 
                Font-Names="Arial" Font-Size="Small" ForeColor="#FF3300" Text=""></asp:Label>
   </td>
</tr>
<tr>
            <td colspan="4" align = "center">
                ...
                <input type=button value="Kết thúc nhập" onClick="CloseForm1();" style="width: 129px; height: 30px; font-weight: bold" /> 
            </td>
</tr>
 <asp:SqlDataSource ID="DonViTinhSL" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                    SelectCommand="SELECT [TenDonViTinh], [MaDVT] FROM [DonViTinh]">
 </asp:SqlDataSource>

</table>
<table cellpadding = "5" cellspacing = "" border = "0"
width = "100%" style="font-family: Arial, Helvetica, sans-serif; font-size: small; font-weight: bold;">
    <tr>
        <td>
        <asp:GridView ID="gr" runat="server" Width="100%" AutoGenerateColumns="False" Visible="false" 
                AllowPaging="True" CellPadding="4" DataKeyNames="VatTuID" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Mã vật tư" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:Label  runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"MaVatTu") %>' ></asp:Label>
                        </ItemTemplate>
...
<asp:HiddenField ID="hiSave" runat="server"  />